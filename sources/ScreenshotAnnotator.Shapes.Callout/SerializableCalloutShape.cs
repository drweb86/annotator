...
public sealed class SerializableCalloutShape : SerializableShape
{
    ...
    public SerializableCalloutShape() => Type = "callout";

    public static SerializableCalloutShape FromShape(CalloutShape callout) => new()
    {
    ...
    public CalloutShape ToShape() => new()
    {
