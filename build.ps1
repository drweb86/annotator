...
ForEach ($platform in $platforms)
{
	...
	& dotnet publish ScreenshotAnnotator.sln "/p:InformationalVersion=$version" `
...
& "c:\Program Files\7-Zip\7z.exe" a -y ".\Output\ScreenshotAnnotator_v$($version)_win-binaries.7z" ".\Output\publish\*" -mx9 -t7z -m0=lzma2 -ms=on -sccUTF-8 -ssw
if ($LastExitCode -ne 0)
{
	Write-Error "Fail." 
	Exit 1
